...
public class Register extends AppCompatActivity {
    DatabaseReference databaseReference = FirebaseDatabase.getInstance().
            getReferenceFromUrl("https://lab99-63b7d-default-rtdb.firebaseio.com/");
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nameTxt.isEmpty() || emailTxt.isEmpty() || mobileTxt.isEmpty() ||
                        passwordTxt.isEmpty() || conpasswordTxt.isEmpty()){
        ...
        loginNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish(); // Optional: depending on how you want to handle navigation
                 }});}}